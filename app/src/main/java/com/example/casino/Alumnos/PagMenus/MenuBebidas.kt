    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = ProductosAdapterAlumnos(
            ...
            { producto ->
                ...
                // Después de la lógica para obtener el producto seleccionado en MenuBebidas
        ...
        productosRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (productoSnapshot in snapshot.children) {
                    ...
                    Log.d("MenuBebidas", "Producto recuperado de la base de datos: $producto")

                    // Verificar si el producto pertenece a la categoría "Bebidas"
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Log.e("MenuBebidas", "Error al leer datos desde Firebase", error.toException())
            }
        })
    }
}
