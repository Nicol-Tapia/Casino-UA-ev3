    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = ProductosAdapterAlumnos(
            ...
            { producto ->
                ...
                // Después de la lógica para obtener el producto seleccionado en MenuComidaRapida
        ...
        productosRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (productoSnapshot in snapshot.children) {
                    ...
                    Log.d("MenuComidaRapida", "Producto recuperado de la base de datos: $producto")

                    // Verificar si el producto pertenece a la categoría "Comida Rápida"
                    if (producto?.categoria == "Comida Rápida") {
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Log.e("MenuComidaRapida", "Error al leer datos desde Firebase", error.toException())
            }
        })
    }
}
