    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = ProductosAdapterAlumnos(
            ...
            { producto ->
                ...
                // Después de la lógica para obtener el producto seleccionado en MenuTeCafe
        ...
        productosRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (productoSnapshot in snapshot.children) {
                    ...
                    Log.d("MenuTeCafe", "Producto recuperado de la base de datos: $producto")

                    // Verificar si el producto pertenece a la categoría "TeCafe"
                    if (producto?.categoria == "Té/Café") {
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Log.e("MenuTeCafe", "Error al leer datos desde Firebase", error.toException())
            }
        })
    }
}
