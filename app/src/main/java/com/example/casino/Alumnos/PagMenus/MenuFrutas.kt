    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = ProductosAdapterAlumnos(
            ...
            { producto ->
                ...
                // Después de la lógica para obtener el producto seleccionado en MenuFrutas
        ...
        productosRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (productoSnapshot in snapshot.children) {
                    ...
                    Log.d("MenuFrutas", "Producto recuperado de la base de datos: $producto")

                    // Verificar si el producto pertenece a la categoría "Frutas"
                ...
                Log.d("MenuFrutas", "Número de elementos en la lista: ${menuItems.size}")
            }

            override fun onCancelled(error: DatabaseError) {
                // Manejar el error de lectura de la base de datos
                Log.e("MenuFrutas", "Error al leer datos desde Firebase", error.toException())
            }
        })
    }
}
