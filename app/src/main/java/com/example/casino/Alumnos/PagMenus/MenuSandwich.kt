    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = ProductosAdapterAlumnos(
            ...
            { producto ->
                ...
                // Después de la lógica para obtener el producto seleccionado en MenuSandwich
        ...
        productosRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (productoSnapshot in snapshot.children) {
                    ...
                    Log.d("MenuSandwich", "Producto recuperado de la base de datos: $producto")

                    // Verificar si el producto pertenece a la categoría "Sandwich"
                ...
                Log.d("MenuSandwich", "Número de elementos en la lista: ${menuItems.size}")
            }

            override fun onCancelled(error: DatabaseError) {
                // Manejar el error de lectura de la base de datos
                Log.e("MenuSandwich", "Error al leer datos desde Firebase", error.toException())
            }
        })
    }
}
