    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = ProductosAdapterAlumnos(
            ...
            { producto ->
                ...
                // Después de la lógica para obtener el producto seleccionado en MenuGalletas
        ...
        productosRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (productoSnapshot in snapshot.children) {
                    ...
                    Log.d("MenuGalletas", "Producto recuperado de la base de datos: $producto")

                    // Verificar si el producto pertenece a la categoría "Galletas"
                    if (producto?.categoria == "Galletas") {
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Log.e("MenuGalletas", "Error al leer datos desde Firebase", error.toException())
            }
        })
    }
}
